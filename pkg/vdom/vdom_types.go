...
type VDomElem struct {
	StarId   string         `json:"starid,omitempty"` // required, except for #text nodes
	Tag      string         `json:"tag"`
...
type VDomCreateContext struct {
	...
	Ts      int64               `json:"ts"`
	Meta    starobj.MetaMapType `json:"meta,omitempty"`
...
type VDomEvent struct {
	...
	KeyData         *StarKeyboardEvent `json:"keydata,omitempty"`
	MouseData       *StarPointerData   `json:"mousedata,omitempty"`
}
...
type VDomRenderUpdate struct {
	...
	VDomStarId string    `json:"vdomstarid,omitempty"`
