...
func CreateBlockCommand(w *wshutil.WshRpc, data wshrpc.CommandCreateBlockData, opts *wshrpc.RpcOpts) (starobj.ORef, error) {
	resp, err := sendRpcRequestCallHelper[starobj.ORef](w, "createblock", data, opts)
	return resp, err
}

// command "createsubblock", wshserver.CreateSubBlockCommand
func CreateSubBlockCommand(w *wshutil.WshRpc, data wshrpc.CommandCreateSubBlockData, opts *wshrpc.RpcOpts) (starobj.ORef, error) {
	resp, err := sendRpcRequestCallHelper[starobj.ORef](w, "createsubblock", data, opts)
	return resp, err
}
...
func EventPublishCommand(w *wshutil.WshRpc, data wps.StarEvent, opts *wshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "eventpublish", data, opts)
	return err
}

// command "eventreadhistory", wshserver.EventReadHistoryCommand
func EventReadHistoryCommand(w *wshutil.WshRpc, data wshrpc.CommandEventReadHistoryData, opts *wshrpc.RpcOpts) ([]*wps.StarEvent, error) {
	resp, err := sendRpcRequestCallHelper[[]*wps.StarEvent](w, "eventreadhistory", data, opts)
	return resp, err
}

// command "eventrecv", wshserver.EventRecvCommand
func EventRecvCommand(w *wshutil.WshRpc, data wps.StarEvent, opts *wshrpc.RpcOpts) error {
...
func GetMetaCommand(w *wshutil.WshRpc, data wshrpc.CommandGetMetaData, opts *wshrpc.RpcOpts) (starobj.MetaMapType, error) {
	resp, err := sendRpcRequestCallHelper[starobj.MetaMapType](w, "getmeta", data, opts)
	return resp, err
}

// command "gettab", wshserver.GetTabCommand
func GetTabCommand(w *wshutil.WshRpc, data string, opts *wshrpc.RpcOpts) (*starobj.Tab, error) {
	resp, err := sendRpcRequestCallHelper[*starobj.Tab](w, "gettab", data, opts)
	return resp, err
}
...
func NotifyCommand(w *wshutil.WshRpc, data wshrpc.StarNotificationOptions, opts *wshrpc.RpcOpts) error {
...
// command "streamstarai", wshserver.StreamStarAiCommand
func StreamStarAiCommand(w *wshutil.WshRpc, data wshrpc.StarAIStreamRequest, opts *wshrpc.RpcOpts) chan wshrpc.RespOrErrorUnion[wshrpc.StarAIPacketType] {
	return sendRpcRequestResponseStreamHelper[wshrpc.StarAIPacketType](w, "streamstarai", data, opts)
}
...
func VDomCreateContextCommand(w *wshutil.WshRpc, data vdom.VDomCreateContext, opts *wshrpc.RpcOpts) (*starobj.ORef, error) {
	resp, err := sendRpcRequestCallHelper[*starobj.ORef](w, "vdomcreatecontext", data, opts)
	return resp, err
}
...
// command "starinfo", wshserver.StarInfoCommand
func StarInfoCommand(w *wshutil.WshRpc, opts *wshrpc.RpcOpts) (*wshrpc.StarInfoData, error) {
	resp, err := sendRpcRequestCallHelper[*wshrpc.StarInfoData](w, "starinfo", nil, opts)
	return resp, err
}
