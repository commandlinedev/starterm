...
// event inverter.  converts StarEvents to a listener.On() API

type singleListener struct {
	Id string
	Fn func(*wps.StarEvent)
}
...
func (el *EventListener) On(eventName string, fn func(*wps.StarEvent)) string {
	id := uuid.New().String()
	el.Lock.Lock()
...
func (el *EventListener) RecvEvent(e *wps.StarEvent) {
