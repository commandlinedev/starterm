...
contextBridge.exposeInMainWorld("api", {
    ...
    onReinjectKey: (callback) => ipcRenderer.on("reinject-key", (_event, starEvent) => callback(starEvent)),
    ...
    onStarInit: (callback) => ipcRenderer.on("star-init", (_event, initOpts) => callback(initOpts)),
