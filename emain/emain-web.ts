...
import { StarBrowserWindow } from "./emain-window";

export function getWebContentsByBlockId(ww: StarBrowserWindow, tabId: string, blockId: string): Promise<WebContents> {
