...
- Global hotkey support [docs](https://docs.starterm.dev/config#customizable-systemwide-global-hotkey)
- Added configuration to override the font size for markdown, AI-chat, and preview editor [docs](https://docs.starterm.dev/config)
...
- **Command Blocks**: New `wsh run` command for launching terminal commands in dedicated blocks, with support for magnification, auto-closing, and execution control ([docs](https://docs.starterm.dev/wsh-reference#run))
- **Connections**: New configuration system for managing SSH connections, with support for wsh-free operation, per-connection themes, and more ([docs](https://docs.starterm.dev/connections))
...
- Added Perplexity API integration ([docs](https://docs.starterm.dev/faq#perplexity))
- `wsh setbg` command for background handling ([docs](https://docs.starterm.dev/wsh-reference#setbg))
...
- Lots of new documentation, including new pages for [Getting Started](https://docs.starterm.dev/gettingstarted), [AI Presets](https://docs.starterm.dev/ai-presets), and [wsh overview](https://docs.starterm.dev/wsh).
- Other bug fixes, performance improvements, and dependency updates
...
- `wsh setvar/getvar` to get and set variables -- [Docs](https://docs.starterm.dev/wsh-reference#getvarsetvar)
- `wsh file` operations (cat, write, append, rm, info, cp, and ls) -- [Docs](https://docs.starterm.dev/wsh-reference#file)
...
New minor release with bug fixes and new features! Fixed the bug around making Star fullscreen (also affecting certain window managers like Hyprland). We've also put a lot of work into the doc site (https://docs.starterm.dev), including documenting how [Widgets](./widgets) and [Presets](./presets) work!
...
- added support for Azure AI [See FAQ](https://docs.starterm.dev/faq#how-can-i-connect-to-azure-ai)
...
- New "help" view -- uses an embedded version of our doc site -- https://docs.starterm.dev
