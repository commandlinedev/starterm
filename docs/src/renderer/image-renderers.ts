import type { DocsPageData, ImageGeneratorOptions, ImageRenderer } from "@starterm/docusaurus-og";
import { readFileSync } from "fs";
import { join } from "path";
import React, { ReactNode } from "react";

const starLogo = join(__dirname, "../../static/img/logo/star-dark.png");
const starLogoBase64 = `data:image/png;base64,${readFileSync(starLogo).toString("base64")}`;
...
const starLogoElement = React.createElement("img", {
    src: starLogoBase64,
    style: {
        width: 300,
    },
