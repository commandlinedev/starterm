# Building Star Terminal

These instructions are for setting up dependencies and building Star Terminal from source on macOS, Linux, and Windows.
...
```sh
git clone git@github.com:commandlinedev/starterm.git
```

or

```sh
git clone https://github.com/commandlinedev/starterm.git
```
...
Backend logs for the development version of Star can be found at `~/.starterm-dev/starapp.log`. Both the NodeJS backend from Electron and the main Go backend will log here.
