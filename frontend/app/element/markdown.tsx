...
const StarBlock: React.FC<StarBlockProps> = (props) => {
    ...
    return (
        <div className="starblock">
            <div className="star-block-content">
                <div className="star-block-icon">
                    <i className="fas fa-file-code"></i>
                </div>
                <div className="star-block-info">
                    <span className="star-block-filename">{displayName}</span>
                    <span className="star-block-size">{sizeInKB} KB</span>
                </div>
            </div>
        </div>
    );
...
const Markdown = ({
    ...
    markdownComponents["starblock"] = (props: any) => <StarBlock {...props} blockmap={contentBlocksMap} />;
        ...
        rehypePlugins = [
            ...
            () =>
                rehypeSanitize({
                    ...
                    tagNames: [...(defaultSchema.tagNames || []), "span", "starblock", "picture", "source"],
                }),
