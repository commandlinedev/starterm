...
class RpcApiType {
    ...
    EventPublishCommand(client: WshClient, data: StarEvent, opts?: RpcOpts): Promise<void> {
        return client.wshRpcCall("eventpublish", data, opts);
    }

    // command "eventreadhistory" [call]
    EventReadHistoryCommand(client: WshClient, data: CommandEventReadHistoryData, opts?: RpcOpts): Promise<StarEvent[]> {
        return client.wshRpcCall("eventreadhistory", data, opts);
    }

    // command "eventrecv" [call]
    EventRecvCommand(client: WshClient, data: StarEvent, opts?: RpcOpts): Promise<void> {
    ...
    // command "notify" [call]
    NotifyCommand(client: WshClient, data: StarNotificationOptions, opts?: RpcOpts): Promise<void> {
