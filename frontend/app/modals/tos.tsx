    ...
    return (
        <>
            <header className="modal-header tos-header unselectable">
                ...
                <div className="modal-title">Welcome to Star Terminal</div>
            </header>
            <div className="modal-content tos-content unselectable">
                <div className="content-section">
                    <div className="icon-wrapper">
                        <a target="_blank" href="https://github.com/commandlinedev/starterm" rel={"noopener"}>
                    ...
                    <div className="content-section-inner">
                        ...
                        <div className="content-section-text">
                            ...
                            <a target="_blank" href="https://github.com/commandlinedev/starterm" rel={"noopener"}>
                                Github&nbsp;(commandlinedev/starterm)
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="content-section-inner">
                        ...
                        <div className="content-section-text">
                            ...
                            <a
                                ...
                                target="_blank"
                                href="https://commandlinedev.github.io/privacy"
                                rel="noopener"
                            >
                                Privacy Policy
                            </a>
...
const ModalPageLegacy = () => {
    ...
    const handleDownloadLegacy = () => {
        getApi().openExternal("https://commandlinedev.github.io/download-legacy?ref=v7upgrade");
    };
    return (
        <>
            <header className="modal-header tos-header unselectable">
                ...
                <div className="modal-title">Welcome to Star v0.9</div>
            </header>
            <div className="modal-content tos-content unselectable">
                <div className="item">
                    We’re excited to announce the release of Star Terminal v0.9. This update introduces a brand-new
                    ...
                    designed to keep you focused and minimize context switching. And for the first time, Star Terminal
                    runs <b>natively on Windows</b>!
                </div>
                <div>
                    Star v0.9 is less opinionated, giving you the freedom to use your standard terminal prompt and
